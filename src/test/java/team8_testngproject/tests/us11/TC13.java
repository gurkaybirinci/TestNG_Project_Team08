...
public class TC13 {
    private final String testName = "US11 || TC13 wishlist  seçeneğini gör.";
    private final String description = "Dashboardın altında wishlist seçeneği görülmeli";
    private final String raporMesaji = "Dashboardın altında  wishlist değil, Wishlist şeklinde görülmektedir";
    ...
    public void test12() {
        ...
        try {
            Assert.assertEquals(p04_myAccountPage.dash_wishlistVendor_Es.getText(), "wishlist");
