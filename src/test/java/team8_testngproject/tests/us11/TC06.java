...
public class TC06 {
    private final String testName = "US11 || TC06 whislist  seçeneğini gör.";
    private final String description = "My Account Sayfasında whislist  seçeneği görülmeli";
    private final String raporMesaji = "My Account sayfasında whislist değil, WISHLIST şeklinde görülmektedir";
