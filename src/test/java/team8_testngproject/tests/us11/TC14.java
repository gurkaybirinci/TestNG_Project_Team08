...
public class TC14 {
    private final String testName = "US11 || TC14 Support tickets seçeneğini gör.";
    private final String description = "Dashboardın altında Support tickets seçeneği görülmeli";
    private final String raporMesaji = "Dashboardın altında  Support tickets değil, Support Tickets şeklinde görülmektedir";
