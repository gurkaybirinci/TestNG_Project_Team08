...
public class TC12 {
    private final String testName = "US11 || TC12 account details  seçeneğini gör.";
    private final String description = "Dashboardın altında account details   seçeneği görülmeli";
    private final String raporMesaji = "Dashboardın altında  account details   değil, Account details şeklinde görülmektedir";
