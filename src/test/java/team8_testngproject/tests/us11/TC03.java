...
public class TC03 {
    private final String testName = "US11 || TC03 Downloads seçeneğini gör.";
    private final String description = "My Account Sayfasında Downloads seçeneği görülmeli";
    private final String raporMesaji = "My Account sayfasında Downloads değil, DOWNLOADS şeklinde görülmektedir";
