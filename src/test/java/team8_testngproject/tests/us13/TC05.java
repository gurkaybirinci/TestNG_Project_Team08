...
public class TC05 {
    private final String testName = "US13 || TC05-Shipping Adress 'last name' alanı alfabetik karakter dışında değer kabul etmemeli";
    ...
    public void tc5() {
        ...
        String data = "123 / /*?";
        addressesPageAli.shippinglastNameAli.sendKeys(data);
        String actualText = ((JavascriptExecutor) Driver.getDriver()).executeScript("return arguments[0].value;", addressesPageAli.shippinglastNameAli).toString();
