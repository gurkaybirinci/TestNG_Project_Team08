...
public class TC09 {
    private final String testName = "US13 || TC09-Shipping Adress 'postcode_zıp' alanı alfabetik  karakter kabul etmemeli";
    ...
    public void tc9() {
        ...
        //     13.  "postcode_zıp" alfabetik kartakter içermemeli/FAİL
