...
public class TC10 {
    private final String testName = "US13 || TC10-Shipping Adress 'city' alanı alfabetik tek karakter kabul etmemeli";
    ...
    public void tc10() {
        ...
        //     14. city alanı tek alfabetik karakter ile save etmemeli

        addressesPageAli.shippingcityAli.clear();
        addressesPageAli.shippingcityAli.sendKeys("A");
        ReusableMethods.jsClick(addressesPageAli.saveAdressButtonAli);

        RaporlamaUtil.extentTestInfo("city alanının alfabetik tek karakter ile save edip etmediği kontrol edilmiştir..");
        try{
