...
public class TC04 {
    ...
    private final String testName = "US12 || TC04-'first name' alanı alfabetik tek karakter kabul etmemeli";
    ...
    public void tc04(){
        ...
        //     10.  "first name" alanına alfabetik tek karakter girilmemeli/FAİL
        addressesPageAli.firstNameAli.clear();
        addressesPageAli.firstNameAli.sendKeys("A");
