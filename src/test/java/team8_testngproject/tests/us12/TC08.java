...
public class TC08 {
    ...
    private final String testName = "US12 || TC08-'Town/city alanı tek karakter ile save etmemeli";
    ...
    public void tc07(){
        ...
        //     13.  "Town/city" alanı tek karakter ile save etmemeli/FAİL
        addressesPageAli.adress2Ali.clear();
        addressesPageAli.adress2Ali.sendKeys("A");
        ReusableMethods.jsClick(addressesPageAli.saveAdressButtonAli);

        RaporlamaUtil.extentTestInfo("Town/city alanı tek karakter ile save dilip edilmediği kontrol edilmiştir.");
