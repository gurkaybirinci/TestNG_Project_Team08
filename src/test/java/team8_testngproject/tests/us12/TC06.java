...
public class TC06 {
    ...
    private final String testName = "US12 || TC06-'last name' alanı alfabetik tek karakter kabul etmemeli";
    ...
    public void tc06(){
        ...
        //    10. "First name" alanına valid deger girilmeli
        addressesPageAli.firstNameAli.clear();
        addressesPageAli.firstNameAli.sendKeys("Preto");


        //     10.  "last name" alanına alfabetik tek karakter girilmemeli/FAİL
        addressesPageAli.lastnameAli.clear();
        addressesPageAli.lastnameAli.sendKeys("A");
