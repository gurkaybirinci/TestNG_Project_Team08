...
public class TC03 {
    private final String testName = "US12 || TC03-'first name' alanı alfabetik karakter dışında değer kabul etmemeli";
    ...
    public void tc03() {
        ...
        String data = "123 / /*?";
        addressesPageAli.firstNameAli.sendKeys(data);
        String actualText = ((JavascriptExecutor) Driver.getDriver()).executeScript("return arguments[0].value;", addressesPageAli.firstNameAli).toString();
