...
public class TC23_Tags_Ekleme { // Tags bölümüne birden fazla tag eklenebilmeli (PASS)
    ...
    public void tc01() {
        ...
        RaporlamaUtil.extentTestInfo("Tags bölümüne birden fazla tag eklenip eklenemediği kontrol edilmiştir.");
