...
public class TC06_Short_Description { // Short Description kutusuna metin girilebilmeli (PASS)
    private final String testName = "US14 || TC06-Short Description";
    private final String description = "Short Description kutusuna metin girilebilmeli";
    private final String raporMesaji = "Short Description kutusuna metin girilebildiği doğrulanmıştır.";
    ...
    public void tc01() {
        ...
        RaporlamaUtil.extentTestInfo("Short Description kutusuna metin girilip girilemediği kontrol edilmiştir.");
