...
public class TC18_Product_Brands_Ekleme { // Product brands bölümüne yeni marka eklerken Product brands Name bölümü boş bırakıldığında bu kutuda bir uyarı mesajı görüntülenmeli (FAIL)
    private final String testName = "US14 || TC18-Product Brands Ekleme";
