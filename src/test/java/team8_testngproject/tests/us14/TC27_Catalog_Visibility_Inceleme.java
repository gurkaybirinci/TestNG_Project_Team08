...
public class TC27_Catalog_Visibility_Inceleme { // Catalog visibility; Shop only olarak seçilediğinde ürüne arama motorundan ulaşılamamalı (FAIL)
    private final String testName = "US14 || TC27-Catalog Visibility İnceleme";
    private final String description = "Catalog visibility; Shop only olarak seçilediğinde ürüne arama motorundan ulaşılamamalı";
    private final String raporMesaji = "Shop only seçeneği seçildiğinde, ürüne arama motorundan da ulaşılabilmektedir. " +
            "Halbuki bu seçenek seçildiğinde arama motorundan bulunamaması gerekir.";
    ...
    public void tc01() {
        ...
        RaporlamaUtil.extentTestInfo("Catalog visibility; Shop only olarak seçilediğinde ürüne arama motorundan ulaşılıp ulaşılamadığı kontrol edilmiştir.");
