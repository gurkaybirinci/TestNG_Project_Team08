...
public class TC05_Product_Title { // Product Title kutusuna metin girilebilmeli (PASS)
    ...
    public void tc01(){
        ...
        RaporlamaUtil.extentTestInfo("Product Title kutusuna metin girilebiliriği kontrol edilmiştir.");

        Assert.assertEquals(vendorProductManagerPage.productTitleGur.getAttribute("value"), productTitle);
        Driver.closeDriver();
