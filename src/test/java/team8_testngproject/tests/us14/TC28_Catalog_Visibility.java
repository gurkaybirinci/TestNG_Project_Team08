...
public class TC28_Catalog_Visibility { // Catalog visibility; Search results only olarak seçilebilmeli (PASS)
    private final String testName = "US14 || TC28-Catalog Visibility";
    private final String description = "Catalog visibility; Search results only olarak seçilebilmeli";
    private final String raporMesaji = "Catalog visibility; Search results only olarak seçilebildiği doğrulanmıştır.";
    ...
    public void tc01() {
        ...
        String expectedOption = "Search results only";
        String actualOption = select.getFirstSelectedOption().getText();
        RaporlamaUtil.extentTestInfo("Catalog visibility; Search results only olarak seçilip seçilemediği kontrol edilmiştir.");
