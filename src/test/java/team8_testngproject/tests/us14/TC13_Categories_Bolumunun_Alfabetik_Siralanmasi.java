...
public class TC13_Categories_Bolumunun_Alfabetik_Siralanmasi { // Categories bölümüne yeni kategori eklerken Parent category menüsündeki seçenekler alfabetik sırada görünmeli (FAIL)
    private final String testName = "US14 || TC13-Categories Bölümünün Alfabetik Sıralanması";
    ...
    public void tc01() {
        ...
        ((JavascriptExecutor) Driver.getDriver()).executeScript("arguments[0].click();", vendorProductManagerPage.parentCategoryGur);
