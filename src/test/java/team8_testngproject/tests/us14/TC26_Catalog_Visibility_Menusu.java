...
public class TC26_Catalog_Visibility_Menusu { // Catalog visibility; Shop only olarak seçilebilmeli (PASS)
    ...
    public void tc01(){
        ...
        RaporlamaUtil.extentTestInfo("Catalog visibility; Shop only olarak seçilip seçilemediği kontrol edilmiştir.");
