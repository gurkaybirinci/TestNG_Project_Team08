...
public class TC29_Catalog_Visibility { // Catalog visibility; Hidden olarak seçilebilmeli (PASS)

    private final String testName = "US14 || TC29-Catalog Visibility";
    private final String description = "Catalog visibility; Hidden olarak seçilebilmeli";
    private final String raporMesaji = "Catalog visibility; Hidden olarak seçilebildiği doğrulanmıştır.";
    ...
    public void tc01() {
        ...
        String expectedOption = "Hidden";
        String actualOption = select.getFirstSelectedOption().getText();
        RaporlamaUtil.extentTestInfo("Catalog visibility; Hidden olarak seçilip seçilemediği kontrol edilmiştir.");
