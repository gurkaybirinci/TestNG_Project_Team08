...
public class US15TC30_AdvancedMenusuPurchaseNoteIslemleri {// Advanced menusunde Purchase Note işlemleri (PASS)
    ...
    public void advancedMenusuPurchaseNoteIslemleri() {
        ...
        Assert.assertTrue(vendorProductManagerPage.advencedPurchaseNoteTextboxRs.isDisplayed());
