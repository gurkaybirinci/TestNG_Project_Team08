...
public class US15TC02_InventoryMenusundeSKUIslemleri { // Inventory menusunde SKU işlemleri (PASS)
    ...
    public void InventoryMenuSKUIslemleri() {
        ...
        vendorProductManagerPage.productTitleInputRs.sendKeys("OyleSoyleBoyle");
